            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <p> Không chỉ thu hút thực khách bằng các món ẩm thực thơm ngon khoái khẩu, NHÀ HÀNG ẨM THỰC FOOD FUNDAY còn chinh phục thực khách bằng sự thân thiện, gần gũi và chuyên nghiệp của đội ngũ nhân viên lễ tân và phục vụ. Mặc dù đông khách, nhưng với số lượng lớn nhân viên phục vụ, quý khách sẽ không phải đợi chờ quá lâu là món ăn nóng hổi, thơm phức đã được mang lên.</p>

                        <p> Nào hãy đến NHÀ HÀNG ẨM THỰC FOOD FUNDAY để khám phá cũng như cảm nhận hương vị riêng của các món đặc sản rừng và hải sản và đánh dấu vào danh sách địa chỉ ẩm thực yêu thích của mình các bạn nhé!</p>
                    </div>
                </div>
                <!-- end col -->
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
